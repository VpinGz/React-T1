...
//     try {
//       const res = await axios.post(`${baseApiUrl}/customer`, data);
...
export function addCustomerById(customer) {
  return fetch(`${baseApiUrl}/customer/$` + (customer.CustomerID || ""), {
    method: customer.CustomerID ? "PUT" : "POST", // POST for create, PUT to update when id already exists.

...
const CustomerForm = () => {
  ...
  const [customer, setCustomerSignUp] = useState(
    { email: '', password: '', firstName: '', lastName: ''}
  );

  const handleChange = (event) => {
    setCustomerSignUp({...customer, [event.target.name]: event.target.value})
  }

  const handleSubmit = (e) => {
    e.preventDefault()
    axios.post(`${baseApiUrl}/customer`)
      ...
      <div className="container">
            <form className='white' onSubmit={handleSubmit}>
                ...
                <div className="input-field">
                    ...
                    <input type="text" name="lastName" value={customer.CustomerName} onChange={handleChange} required />
                </div>
                <div className="input-field"> 
